                    ...
                    if (pikachu[0] === "2" && squirtle[0] === "3") {
                        ...
                        if (bulba[0] === "2" && pikachu[0] === "3") {
                            ...
                            if (bulba[1] <= 0) {
                                ...
                                pikachu[0] = 4;
                                if (pikachu[0] === 4 && charmander[0] === 4 && squirtle[0] === 4) {
                                    console.log("final")
                                    $("#fight-botton").css("display", "none");
                                    $("#YouWin").css("display", "block");
                                } else {
                        ...
                        if (charmander[0] === "2" && pikachu[0] === "3") {
                            ...
                            if (charmander[1] <= 0) {
                                ...
                                pikachu[0] = 4;
                                if (pikachu[0] === 4 && bulba[0] === 4 && squirtle[0] === 4) {
                                    $("#fight-botton").css("display", "none");
                                    $("#YouWin").css("display", "block");
                                } else {
                                    $("#pikachu-right").css("display", "none");
                        ...
                        if (squirtle[0] === "2" && pikachu[0] === "3") {
                            ...
                            if (squirtle[1] <= 0) {
                                ...
                                pikachu[0] = 4;
                                if (pikachu[0] === 4 && bulba[0] === 4 && charmander[0] === 4) {
                                    $("#fight-botton").css("display", "none");
                                    $("#YouWin").css("display", "block");
                                } else {
                                    $("#pikachu-right").css("display", "none");
